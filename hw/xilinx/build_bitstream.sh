...
#map -intstyle ise -p ${DEVICE} -w -logic_opt on -ol high -t 1 -xt 1 -register_duplication off -r 4 -global_opt off -mt off -ir off -pr b -lc off -power off -o ${TARGET}_map.ncd ${TARGET}.ngd ${TARGET}.pcf
